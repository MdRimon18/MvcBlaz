...
namespace GarmentsERP.Controllers
{
    ...
    public class ProductSubDepartmentsController : ControllerBase
    {
        ...
        {
            var result =
                 await (from productSubtbl in _context.ProductSubDepartments
                        
                        join buyerPrfle in _context.BuyerProfiles on productSubtbl.BuyerNameId equals buyerPrfle.Id into buyerPrfles
                        from buyerPrfle in buyerPrfles.DefaultIfEmpty()

                       

                        orderby productSubtbl.Id descending
                        select new ProductSubDepartment
                        {

                           Id=productSubtbl.Id,
                             SubDepartmentName=productSubtbl.SubDepartmentName,
                             DepartnemtName=productSubtbl.DepartnemtName,
                             BuyerNameId=productSubtbl.BuyerNameId,
        ...
        {
            var productSubDepartment = await _context.ProductSubDepartments.FindAsync(id);
        ...
        public async Task<ActionResult<ProductSubDepartment>> PostProductSubDepartment( ProductSubDepartment productSubDepartment)
        {
            ...
            _context.ProductSubDepartments.Add(productSubDepartment);
            await _context.SaveChangesAsync();
        ...
        public async Task<ActionResult<ProductSubDepartment>> DeleteProductSubDepartment(int id)
        {
            ...
            _context.ProductSubDepartments.Remove(productSubDepartment);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.ProductSubDepartments.Any(e => e.Id == id);
        }
    }
}
