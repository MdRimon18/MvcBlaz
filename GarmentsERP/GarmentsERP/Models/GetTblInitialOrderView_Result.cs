...
namespace GarmentsERP.Models
{
    ...
    public partial class GetTblInitialOrderView_Result
    {
        public int OrderAutoID { get; set; }
        public string JobNo { get; set; }
        public string JobNoAfterSplit { get; set; }
